...
import com.example.luigi.spesapp.SharedPreferenceUtility;
import com.example.luigi.spesapp.UserDatabaseManager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                UserDatabaseManager userDatabaseManager = new UserDatabaseManager(getContext());
                Intent intent = new Intent(getActivity(), MainActivity.class);
                String user = SharedPreferenceUtility.readUserFromSharedPreferences(getContext());
